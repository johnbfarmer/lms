...
const Index = ({ auth, lesson, lessonIds, problemSet, pageAssets}) => {
    ...
    let topMenu = (
        <TopMenu auth={auth} title={ title } lessonId={ lesson.id }  neighboringLessons={ lessonIds } chapterId={lesson.lesson_set_id} show={['home', 'prob-set', 'prob-add', 'lesson-nav', 'course', 'chapter', 'lesson-edit']} />
    )
